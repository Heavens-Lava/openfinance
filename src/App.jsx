...
function ImportView({ data, status, onFiles, onDemo, onLocal, onClear, pendingImport, onRestore, onDiscardPending, mode }) {
  ...
  return <div className="view">
    ...
    {!AUTH_REQUIRED && <p className="trust-links"><a href="https://finance.jeffreymacy.com/about/" target="_blank" rel="noreferrer">About OpenFinance</a><span>·</span><a href="https://finance.jeffreymacy.com/privacy/" target="_blank" rel="noreferrer">How local storage and deletion work</a><span>·</span><a href="https://finance.jeffreymacy.com/security/" target="_blank" rel="noreferrer">Security and accuracy limitations</a><span>·</span><a href="https://github.com/Heavens-Lava/openfinance" target="_blank" rel="noreferrer">Review the source</a></p>}
